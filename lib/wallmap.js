...
let wallmapVisible = false;
new IntersectionObserver((entries) => {
    wallmapVisible = entries[0].isIntersecting;
}, { threshold: 0.1 }).observe(document.getElementById('wallmap-section'));
...
function init() {
    ...
    let selector = document.querySelector( '#canvas-wallmap' );
    selector.innerHTML = "";
