...
let selector = document.querySelector("#canvas-cloth");
...
new IntersectionObserver((entries) => {
  clothVisible = entries[0].isIntersecting;
}, { threshold: 0.1 }).observe(document.getElementById('cloth-section'));
...
function init() {
  ...
  controls.minPolarAngle = Math.PI / 2 - THREE.MathUtils.degToRad(40);
